export class ItemApi{
    ...
    async saveProduct(productModel) {
        ...
        try {
            const response = await this.sendAjaxRequest("http://localhost:8080/shoe/api/v1/inventory", "POST", formData);
        } catch (error) {
    ...
    getAllProducts() {
        return this.sendAjaxRequest("http://localhost:8080/shoe/api/v1/inventory/getAllItems", "GET");
    }
    ...
    updateProduct(product, itemCodeUpdate) {
        ...
        return this.sendAjaxRequest(`http://localhost:8080/shoe/api/v1/inventory/${itemCodeUpdate}`, "PUT",formData);
    }

    deleteProduct(itemCodeDel) {
        return this.sendAjaxRequest(`http://localhost:8080/shoe/api/v1/inventory/${itemCodeDel}`, "DELETE");
    }
