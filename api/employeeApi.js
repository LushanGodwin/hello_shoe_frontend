export class EmployeeApi {
    ...
    async getAllEmployees() {
        return this.sendAjaxRequest("http://localhost:8080/shoe/api/v1/employee", "GET");
    }

    async getEmployee(employeeId) {
        return this.sendAjaxRequest(`http://localhost:8080/shoe/api/v1/employee/${employeeId}`, "GET");
    }
    ...
    async updateEmployee(employeeModel) {
        ...
        return this.sendAjaxRequest(`http://localhost:8080/shoe/api/v1/employee/${employeeModel.employeeCode}`, "PUT",formData);
    }
}