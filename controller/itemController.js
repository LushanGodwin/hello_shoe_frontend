...
$(document).ready(function () {
    ...
    function populateGenderComboBox() {
        productListApi.getAllGenders()
            .then(response => {
                populateComboBox('item-gender', response, 'genderCode', 'gender_desc', 'Select Gender');
            })
            .catch(error => {
                console.log(error);
    ...
    itemAddBtn.on('click', function () {
        ...
        itemForm[0].reset();
        updateImagePreview('./assets/image/previewImg.png');
                ...
                <div class="col-md-4 mb-4">
                    <div class="product-card">
                        ...
                        <div class="product-details">
                            ...
                            <p><strong>Gender:</strong> ${product.genderEntity.gender_desc}</p>
                        ...
                        <div class="product-bottom-details">
                            <div class="product-links">
                                <button type="button" class="update-icon btn btn-link" 
                                    ...
                                    data-gender="${product.genderEntity.gender_desc}" 
    ...
    function deleteProduct(itemCodeDel) {
