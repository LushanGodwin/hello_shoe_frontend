        ...
        return supplierApi.getAllSuppliers()
            .then((responseText) => {
                ...
                responseText.forEach((supplier) => {
                    supplierId.append(
                        `<option value="${supplier.supplier_name}">${supplier.supplierCode}</option>`
                    );
                });
            })
            .catch((error) => {
            ...
            .then((responseText) => {
                ...
                stock_db.forEach((stock) => {
                    ...
                    tableBody.append(
                        ...
                        <td>${stock.supplierEntity.supplier_name}</td>
                        ...
                        <td>
                            <button class="updateBtn btn btn-warning btn-sm" data-toggle="modal" data-target="#stockModal"
                                ...
                                data-supplier-name="${stock.supplierEntity.supplier_name}"
